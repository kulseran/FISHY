...
class ComparisonChain {
  ...
  ComparisonChain &andOne(const ComparisonChain &child);

  ComparisonChain &andOne(const int &child);
  ...
  ComparisonChain &orOne(const ComparisonChain &child);

  ComparisonChain &orOne(const int &child);

  /**
   * Logical And the result of all these comparison to the chain.
   * Containers length difference is treased as {@link #and}(lengthLhs,
   * lengthRhs).
   */
